...
module.exports = async function handler(req, res) {
  ...
  const fredUrl = `https://api.stlouisfed.org/fred/series/observations?series_id=${encodeURIComponent(series_id)}&api_key=${apiKey}&sort_order=asc&limit=${encodeURIComponent(limit)}&file_type=json`;
